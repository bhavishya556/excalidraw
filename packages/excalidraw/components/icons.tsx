...
export const ExportPDFIcon = createIcon(
  <g strokeWidth="1.25">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    {/* Page outline with a folded corner */}
    <path d="M12 20h-5a3 3 0 0 1 -3 -3v-10a3 3 0 0 1 3 -3h7l5 5v8a3 3 0 0 1 -3 3z"></path>
    <path d="M16 8l0 -4l4 4"></path>
    {/* PDF export arrow */}
    <path d="M19 16v6"></path>
    <path d="M22 19l-3 3l-3 -3"></path>
    {/* Inner lines to mimic text */}
    <path d="M8 10h5"></path>
    <path d="M8 14h3"></path>
  </g>,
  tablerIconProps,
