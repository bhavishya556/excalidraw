...
export const SaveAsPdf = () => {
  ...
  return (
    <DropdownMenuItem
      ...
      onSelect={() => setAppState({ openDialog: { name: "pdfExport" } })}
      shortcut={getShortcutFromShortcutName("pdfExport")}
      aria-label={t("buttons.exportPdf")}
    >
      {t("buttons.exportPdf")}
    </DropdownMenuItem>
  );
};
SaveAsImage.displayName = "SaveAsPdf";
